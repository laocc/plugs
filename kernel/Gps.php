...
class Gps
{
     ...
     */
    public static function span($lat1, $lng1, $_lat = 0, $_lng = 0)
    {
     ...
     * @return string
     */
    public static function address($lat, $lng, $from = 'baidu')
    {
    ...
    /**
     * 根据地址查GPS座标，如：江苏省苏州市星湖街123号，江苏苏州星湖街234号
     * @param $address
     * @return string
     */
