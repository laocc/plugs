...
final class Input
{
     ...
     */
    public static function get($param = null, $autoValue = null)
    {
        return self::requestParams($param, $autoValue, $_GET, 'get');
    }

    public static function post($param = null, $autoValue = null)
    {
     ...
     */
    private static function requestParams($param = null, $autoValue = null, &$dataValue = [], $from)
    {
        if ($param === null) {
